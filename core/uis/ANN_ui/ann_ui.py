...
class Ui_ANN(object):
    ...
    def retranslateUi(self, ANN):
        ...
        self.outputLineEdit.setToolTip(_translate("ANN", "<html><head/><body><p>LSAT will create two files with the given name.</p><p>*name*.tif in \\results\\ANN\\rasters\\ and</p><p>*name*.npz in \\results\\ANN\\tables\\</p></body></html>"))
