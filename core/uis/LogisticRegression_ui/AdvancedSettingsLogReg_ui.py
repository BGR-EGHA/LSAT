...
class Ui_AdvancedSettingsLogReg(object):
    ...
    def retranslateUi(self, AdvancedSettingsLogReg):
        ...
        self.randomStateComboBox.setItemText(1, _translate("AdvancedSettingsLogReg", "Random state instance"))
        self.randomStateComboBox.setItemText(2, _translate("AdvancedSettingsLogReg", "None"))
