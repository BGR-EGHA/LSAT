...
class Ui_LogisticRegressionFrame(object):
    ...
    def retranslateUi(self, LogisticRegressionFrame):
        ...
        #self.treeWidget.headerItem().setText(2, _translate("LogisticRegressionFrame", "Sorting"))
        ...
        self.outputlineEdit.setToolTip(_translate("LogisticRegressionFrame", "<html><head/><body><p>LSAT will create two files with the given name.</p><p>*name*.tif in \\results\\LR\\rasters\\ and</p><p>*name*.npz in \\results\\LR\\tables\\</p></body></html>"))
